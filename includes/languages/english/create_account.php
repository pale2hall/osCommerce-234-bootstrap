...
define('TEXT_ORIGIN_LOGIN', '<span class="inputRequirement"><strong>NOTE:</strong></span> If you already have an account with us, please login at the <a href="%s">login page</a>.');
